...
namespace rsurfaces
{
    ...
    class TPEnergyCutOff : public SurfaceEnergy
    {
    public:
        ~TPEnergyCutOff(){};
        
        TPEnergyCutOff( MeshPtr mesh_, GeomPtr geom_, CutOffBlockClusterTree * bct_, mreal alpha_, mreal beta_, mreal weight_)
        {
            mesh = mesh_;
            geom = geom_;
            bct = bct_;
