...
namespace rsurfaces
{
    ...
    class TPObstacleMultipole_Projectors0 : public SurfaceEnergy
    {
    public:
        ~TPObstacleMultipole_Projectors0(){};
        
        TPObstacleMultipole_Projectors0( MeshPtr mesh_, GeomPtr geom_, OptimizedBlockClusterTree * bct_, mreal alpha_, mreal beta_, mreal weight_ )
        {
            mesh = mesh_;
            geom = geom_;
            bct = bct_;
