...
namespace rsurfaces
{
    ...
    class TPObstacleCutOff : public SurfaceEnergy
    {
    public:
        ~TPObstacleCutOff(){};
        
        TPObstacleCutOff( MeshPtr mesh_, GeomPtr geom_, CutOffBlockClusterTree * bct_, mreal alpha_, mreal beta_, mreal weight_ )
        {
            mesh = mesh_;
            geom = geom_;
            bct = bct_;
        ...
        CutOffBlockClusterTree * GetBCT();
        
        bool use_int = true;
    private:
        CutOffBlockClusterTree * bct = nullptr;
