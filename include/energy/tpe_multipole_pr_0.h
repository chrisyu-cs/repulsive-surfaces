...
namespace rsurfaces
{
    ...
    class TPEnergyMultipole_Projectors0 : public SurfaceEnergy
    {
    public:
        ~TPEnergyMultipole_Projectors0(){};
        
        TPEnergyMultipole_Projectors0( MeshPtr mesh_, GeomPtr geom_, OptimizedBlockClusterTree * bct_, mreal alpha_, mreal beta_, mreal weight_)
        {
            mesh = mesh_;
            geom = geom_;
            bct = bct_;
