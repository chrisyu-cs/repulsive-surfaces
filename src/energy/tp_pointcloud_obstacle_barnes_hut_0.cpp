...
namespace rsurfaces
{
    ...
    mreal TPPointCloudObstacleBarnesHut0::Energy(T1 alpha, T2 betahalf)
    {
        ptic("TPPointCloudObstacleBarnesHut0::Energy");
        ...
        ptoc("TPPointCloudObstacleBarnesHut0::Energy");
        
        return sum;
    }; //Energy

    template <typename T1, typename T2>
    mreal TPPointCloudObstacleBarnesHut0::DEnergy(T1 alpha, T2 betahalf)
    {
        ptic("TPPointCloudObstacleBarnesHut0::DEnergy");
        ...
        ptoc("TPPointCloudObstacleBarnesHut0::DEnergy");
        
        return sum;
    }; // DEnergy
    
    double TPPointCloudObstacleBarnesHut0::Value()
    {
        ptic("TPPointCloudObstacleBarnesHut0::Value");
        ...
        ptoc("TPPointCloudObstacleBarnesHut0::Value");
        
        return value;
    } // Value

    void TPPointCloudObstacleBarnesHut0::Differential(Eigen::MatrixXd &output)
    {
        ptic("TPPointCloudObstacleBarnesHut0::Differential");
        ...
        if( bvh->near_dim != 7)
        {
            eprint("in TPPointCloudObstacleBarnesHut0::Differential: near_dim != 7");
        }
        ...
        ptoc("TPPointCloudObstacleBarnesHut0::Differential");
        
    } // Differential
    
    // Update the energy to reflect the current state of the mesh. This could
    // involve building a new BVH for Barnes-Hut energies, for instance.
    void TPPointCloudObstacleBarnesHut0::Update()
    {
        ptic("TPPointCloudObstacleBarnesHut0::Update");
        ...
        ptoc("TPPointCloudObstacleBarnesHut0::Update");
    }

    // Get the mesh associated with this energy.
    MeshPtr TPPointCloudObstacleBarnesHut0::GetMesh()
    {
        return mesh;
    }

    // Get the geometry associated with this geometry.
    GeomPtr TPPointCloudObstacleBarnesHut0::GetGeom()
    {
        return geom;
    }

    // Get the exponents of this energy; only applies to tangent-point energies.
    Vector2 TPPointCloudObstacleBarnesHut0::GetExponents()
    {
    ...
    OptimizedClusterTree *TPPointCloudObstacleBarnesHut0::GetBVH()
    {
        return o_bvh;
    }
    ...
    double TPPointCloudObstacleBarnesHut0::GetTheta()
    {
        return theta;
    }
