...
namespace rsurfaces
{
    ...
    mreal TPPointNormalCloudObstacleBarnesHut0::Energy(T1 alpha, T2 betahalf)
    {
        ptic("TPPointNormalCloudObstacleBarnesHut0::Energy");
        ...
        ptoc("TPPointNormalCloudObstacleBarnesHut0::Energy");
        
        return sum;
    }; //Energy

    template <typename T1, typename T2>
    mreal TPPointNormalCloudObstacleBarnesHut0::DEnergy(T1 alpha, T2 betahalf)
    {
        ptic("TPPointNormalCloudObstacleBarnesHut0::DEnergy");
        ...
        ptoc("TPPointNormalCloudObstacleBarnesHut0::DEnergy");
        
        return sum;
    }; // DEnergy
    
    double TPPointNormalCloudObstacleBarnesHut0::Value()
    {
        ptic("TPPointNormalCloudObstacleBarnesHut0::Value");
        ...
        ptoc("TPPointNormalCloudObstacleBarnesHut0::Value");
        
        return value;
    } // Value

    void TPPointNormalCloudObstacleBarnesHut0::Differential(Eigen::MatrixXd &output)
    {
        ptic("TPPointNormalCloudObstacleBarnesHut0::Differential");
        ...
        if( bvh->near_dim != 7)
        {
            eprint("in TPPointNormalCloudObstacleBarnesHut0::Differential: near_dim != 7");
        }
        ...
        ptoc("TPPointNormalCloudObstacleBarnesHut0::Differential");
        
    } // Differential
    
    // Update the energy to reflect the current state of the mesh. This could
    // involve building a new BVH for Barnes-Hut energies, for instance.
    void TPPointNormalCloudObstacleBarnesHut0::Update()
    {
        ptic("TPPointNormalCloudObstacleBarnesHut0::Update");
        ...
        ptoc("TPPointNormalCloudObstacleBarnesHut0::Update");
    }

    // Get the mesh associated with this energy.
    MeshPtr TPPointNormalCloudObstacleBarnesHut0::GetMesh()
    {
        return mesh;
    }

    // Get the geometry associated with this geometry.
    GeomPtr TPPointNormalCloudObstacleBarnesHut0::GetGeom()
    {
        return geom;
    }

    // Get the exponents of this energy; only applies to tangent-point energies.
    Vector2 TPPointNormalCloudObstacleBarnesHut0::GetExponents()
    {
    ...
    OptimizedClusterTree *TPPointNormalCloudObstacleBarnesHut0::GetBVH()
    {
        return o_bvh;
    }
    ...
    double TPPointNormalCloudObstacleBarnesHut0::GetTheta()
    {
        return theta;
    }
